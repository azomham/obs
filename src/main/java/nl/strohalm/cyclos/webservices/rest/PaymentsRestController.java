...
public class PaymentsRestController extends BaseRestController {
    ...
    //AzAm
    @RequestMapping(value = "payments/do/memberPayment", method = RequestMethod.POST)
    @ResponseBody
    public ConfirmPaymentResult DoMemberPayment(@RequestBody final DoMemberPaymentParameters params) {
        if (params == null) {
            throw new ValidationException();
        }
     ...
     */
    @RequestMapping(value = "payments/do/systemPayment", method = RequestMethod.POST)
    @ResponseBody
    public ConfirmPaymentResult doSystemPayment(@RequestBody final DoPaymentParameters params) {
